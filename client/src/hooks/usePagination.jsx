import { generateRange } from '@/ultils/fn'
...
const usePagination = (totalProductCount, currentPage, limit, siblingCount = 1) => {
    const paginationArray = useMemo(() => {
        const pageSize = +limit || +import.meta.env.VITE_LIMIT || 10 // Items per page
        const paginationCount = Math.ceil(totalProductCount / pageSize) // Pages number
